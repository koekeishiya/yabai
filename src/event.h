...
enum event_type
{
    ...
    APPLICATION_VISIBLE,
    APPLICATION_HIDDEN,
    APPLICATION_IS_UNRESPONSIVE,
    APPLICATION_IS_RESPONSIVE,
    WINDOW_CREATED,
    WINDOW_DESTROYED,
    WINDOW_FOCUSED,
    WINDOW_MOVED,
...
static const char *event_type_str[] =
{
    ...
    [APPLICATION_IS_UNRESPONSIVE]    = "application_is_unresponsive",
    [APPLICATION_IS_RESPONSIVE]      = "application_is_responsive",
...
static event_callback *event_handler[] =
{
    ...
    [APPLICATION_IS_UNRESPONSIVE]    = EVENT_HANDLER_APPLICATION_IS_UNRESPONSIVE,
    [APPLICATION_IS_RESPONSIVE]      = EVENT_HANDLER_APPLICATION_IS_RESPONSIVE,
