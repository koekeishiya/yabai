...
CGRect display_manager_menu_bar_rect(uint32_t did)
{
    ...
    //
    // NOTE(john-json): SLSGetRevealedMenuBarBounds is broken on Apple Silicon,
    ...
    //
    // NOTE(john-json): Height needs to be offset by 1 because that is the actual
