...
void event_signal_push(enum signal_type type, void *context)
{
    ...
    case SIGNAL_APPLICATION_VISIBLE:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_PROCESS_ID");
    ...
    case SIGNAL_APPLICATION_FRONT_SWITCHED:
    {
        ...
        snprintf(es->arg_name[1], arg_size, "%s", "nimbuswm_RECENT_PROCESS_ID");
    ...
    case SIGNAL_WINDOW_DEMINIMIZED:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_WINDOW_ID");
    ...
    case SIGNAL_SPACE_CREATED:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_SPACE_ID");
        snprintf(es->arg_value[0], arg_size, "%lld", sid);
        snprintf(es->arg_name[1], arg_size, "%s", "nimbuswm_SPACE_INDEX");
    ...
    case SIGNAL_SPACE_CHANGED:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_SPACE_ID");
        snprintf(es->arg_value[0], arg_size, "%lld", sid);
        snprintf(es->arg_name[1], arg_size, "%s", "nimbuswm_RECENT_SPACE_ID");
        snprintf(es->arg_value[1], arg_size, "%lld", recent_sid);

        snprintf(es->arg_name[2], arg_size, "%s", "nimbuswm_SPACE_INDEX");
        snprintf(es->arg_value[2], arg_size, "%d", index);
        snprintf(es->arg_name[3], arg_size, "%s", "nimbuswm_RECENT_SPACE_INDEX");
    ...
    case SIGNAL_DISPLAY_RESIZED:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_DISPLAY_ID");
        snprintf(es->arg_value[0], arg_size, "%d", did);
        snprintf(es->arg_name[1], arg_size, "%s", "nimbuswm_DISPLAY_INDEX");
        snprintf(es->arg_value[1], arg_size, "%d", index);
    }
    break;
    ...
    case SIGNAL_DISPLAY_CHANGED:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_DISPLAY_ID");
        snprintf(es->arg_value[0], arg_size, "%d", did);
        snprintf(es->arg_name[1], arg_size, "%s", "nimbuswm_RECENT_DISPLAY_ID");
        snprintf(es->arg_value[1], arg_size, "%d", recent_did);

        snprintf(es->arg_name[2], arg_size, "%s", "nimbuswm_DISPLAY_INDEX");
        snprintf(es->arg_value[2], arg_size, "%d", index);
        snprintf(es->arg_name[3], arg_size, "%s", "nimbuswm_RECENT_DISPLAY_INDEX");
        snprintf(es->arg_value[3], arg_size, "%d", recent_index);
    }
    break;
    ...
    case SIGNAL_MISSION_CONTROL_EXIT:
    {
        ...
        snprintf(es->arg_name[0], arg_size, "%s", "nimbuswm_MISSION_CONTROL_MODE");
