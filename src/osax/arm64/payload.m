...
const char *get_dock_spaces_pattern(NSOperatingSystemVersion os_version) {
    if (os_version.majorVersion == 13) {
        if (os_version.minorVersion >= 3) {
            return "93 17 00 ?0 73 ?2 ?? 91 60 02 40 F9 E2 03 17 AA ?? ?? 07 94 FD 03 1D AA";
        }
...
const char *get_dppm_pattern(NSOperatingSystemVersion os_version) {
    if (os_version.majorVersion == 13) {
        if (os_version.minorVersion >= 3) {
            return "00 20 00 D0 00 ?0 ?? 91 E1 03 13 AA ?? ?? 0B 94 13 2E 00 B4 16 20 00 D0";
        }
...
const char *get_remove_space_pattern(NSOperatingSystemVersion os_version) {
    if (os_version.majorVersion == 13) {
        if (os_version.minorVersion >= 3) {
            // radare2 string: 7f2303d5ff0303d1fc6f06a9fa6707a9f85f08a9f65709a9f44f0aa9fd7b0ba9fdc30291c80a00f0
            return "7F 23 03 D5 FF 03 03 D1 FC 6F 06 A9 FA 67 07 A9 F8 5F 08 A9 F6 57 09 A9 F4 4F 0A A9 FD 7B 0B A9 FD C3 02 91 C8 0A 00 F0";
        }
        ...
        // radare2 string: 
        // 7F2303D5FF8303D1FC6F08A9FA6709A9F85F0AA9F6570BA9F44F0CA9FD7B0DA9FD430391F70303AAF60302AAF50301AAF30300AAF40301AA....FD97F40300AA08FC7ED3....00B588E27D92000940F91F0800F1..0E0054........F5..........00..1F2003D508....F96802088B146940A9..0A00..1F2003D500....F9480900..01....F9F3..00F9E20313AA
...
const char *get_move_space_pattern(NSOperatingSystemVersion os_version) {
    if (os_version.majorVersion == 13) {
        if (os_version.minorVersion >= 3) {
            return "7F 23 03 D5 FF C3 01 D1 E3 03 1E AA EB 55 00 94 FE 03 03 AA FD 7B 06 A9 FD 83 01 91 F6 03 14 AA F4 03 02 AA FA 03 01 AA FB 03 00 AA 37 0B 00 D0";
        }
...
const char *get_set_front_window_pattern(NSOperatingSystemVersion os_version) {
    if (os_version.majorVersion == 13) {
        ...
        return "7F 23 03 D5 FF 83 02 D1 F6 57 07 A9 F4 4F 08 A9 FD 7B 09 A9 FD 43 02 91 68 1A 00 90 08 FD 45 F9 08 01 40 F9 A8 83 1D F8 FF 1F 00 F9 C1 10 00 34 F3 03 01 AA F4 03 00 AA 15 FC 60 D3 FF DF 00 39 E1 DF 00 91 A1 94 00 94 60 1A 00 90 00 C0 46 F9";
    } else if (os_version.majorVersion == 12) {
