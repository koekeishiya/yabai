...
*--close* ['<WINDOW_SEL>']::
    Close the given window. If none specified, close the selected window instead. +
    Only works on windows that provide a close button in its titlebar.

*--minimize* ['<WINDOW_SEL>']::
    Minimize the given window. If none specified, minimize the selected window instead. +
