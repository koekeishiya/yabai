...
'status_bar_text_font'::
    ...
    Format: '<font_family>:<font_style>:<font_size>'. +
...
'focus_follows_mouse'::
    ...
    Accept the following values: *autofocus*, *autoraise*, *off*.
...
'window_shadow'::
    ...
    Accept the following values: *on*, *float*, *off*.
...
'window_border_placement'::
    ...
    Accept the following values: *exterior*, *interior*, *inset*.
...
'mouse_modifier'::
    ...
    Accept the following values: *cmd*, *alt*, *shift*, *ctrl*, *fn*.

'mouse_action1'::
'mouse_action2'::
    Action performed when pressing 'mouse_modifier' + 'button<n>'. +
    Accept the following values: *move*, *resize*.
...
'layout'::
    ...
    Accept the following values: *bsp*, *float*.
