...
yabai allows you to control your windows, spaces and displays freely using an intuitive command line interface and optionally set user-defined keyboard shortcuts using tight integration with [&nearr;&nbsp;skhd](https://github.com/koekeishiya/skhd) and other third-party software.
